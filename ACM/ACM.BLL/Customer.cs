...
namespace ACM.BLL
{
    ...
    {
        //Default conatructor=>REQUIRED WHEN MULTIPLE CONSTRUCTORS DEFINED and aditionally, usually required for initializate instances with autogenerated properties
        public Customer()
        {
